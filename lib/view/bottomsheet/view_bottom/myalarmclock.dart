...
class alarmhourdetail extends StatefulWidget {
  const alarmhourdetail({Key? key}) : super(key: key);

  @override
  State<alarmhourdetail> createState() => _alarmhourdetailState();
}

class _alarmhourdetailState extends State<alarmhourdetail> {
                ...
                itemBuilder: (BuildContext context, int index){
                  return Column(
                    ...
                    children: [
                      ...
                      init.myalarm[init.myalarmindex].alarm[index].hours.length!=0?
                      ListView.builder(
                          physics: NeverScrollableScrollPhysics(),
                          scrollDirection: Axis.vertical,
                          shrinkWrap: true,
                          itemCount: init.myalarm[init.myalarmindex].alarm[index].hours.length,
                                              ...
                                              Row(
                                                children: [
                                                  Text(DateFormat().add_jm().format(
                                                      DateFormat("HH").parse( init.myalarm[init.myalarmindex].alarm[index].hours[index1].toString())),style: TextStyle(fontSize: 32)),
                                                ],
                                              ),
                                              // Row(
                                          ...
                                          children: <Widget>[
                                            ListTile(title: Column(
                                              children: [
                                                ...
                                                // InkWell(
                                                //   onTap: (){
                                                //     init.myalarm[init.myalarmindex].alarm[index].hours.removeAt(index1);
                                                //     print("delete");
                                                //     setState(() {
                                                //
                                                //     });
